...
/**
 * DeadlineCountdown (C-02) — days-until-deadline with severity colour.
 * Negative = overdue. Pairs colour with icon + text (DD-UI-5).
 */
export default function DeadlineCountdown({ days }) {
  let color, text, overdue;
  if (days < 0) {
    color = "#eb143f";
    text = `Overdue ${-days}d`;
    overdue = true;
