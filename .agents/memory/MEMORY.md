...
- [Authenticated screenshots](screenshot-dev-session.md) — app has no auto-login; prime screenshot browser with `screenshot(path="/api/dev/session")` before app pages or everything shows Unauthorized.
