...
| 2026-06-24 | Platform setup: naming, infra boundaries, merge mechanics | `LL-2026-06-24-platform-setup-naming-infra-merge.md` |
| 2026-06-24 | Build plan + project tracking: churn, then reuse helm | `LL-2026-06-24-build-plan-tracking-and-helm-reuse.md` |
